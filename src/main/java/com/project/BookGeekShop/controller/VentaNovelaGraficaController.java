...
public class VentaNovelaGraficaController {
    ...
    public String inicio(Model model) {
        var ventasNovelaGraficas = ventaNovelaGraficaService.getVentaNovelasGraficas();
        model.addAttribute("ventaNovelaGraficas", ventasNovelaGraficas);
        model.addAttribute("totalVentasNovelaGraficas", ventasNovelaGraficas.size());
