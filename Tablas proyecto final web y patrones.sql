...
insert into libro(id_libro,nombre,autor,genero,editorial,fecha_publicacion,cantidad,precio,imagen)
values
(1,'Maze Runner Correr o Morir','James Dashner','Ciencia Ficcion','V&R','20090106',3,12800.00,'https://contentv2.tap-commerce.com/cover/large/9789876122672_1.jpg?id_com=1113'),
(2,'Divergente','Veronica Roth','Ciencia Ficcion','RBA','20110426',1,10800.00,'https://m.media-amazon.com/images/I/81lWVW-H5JL.jpg'),
(3,'El Hobbit','J.R.R. Tolkien','Fantasia','Booket','19370109',5,10800.00,'https://imagessl6.casadellibro.com/a/l/t5/56/9788445000656.jpg');

insert into novela_grafica(id_novelaG,nombre,tipo,autor,genero,editorial,fecha_publicacion,cantidad,precio,imagen)
values
(1,'V For Vendetta','Comic estadounidense','Alan Moore & David Lloyd','Politica','Vertigo','20081024',3,21000.00,'https://m.media-amazon.com/images/I/71f7i5dHDSL._AC_UF1000,1000_QL80_.jpg'),
(2,'Flashpoint','Comic estaunidense','Geoff Johns et al.','Accion','DC Comics','20120313',1,14500.00,'https://upload.wikimedia.org/wikipedia/en/4/4f/Flashpoint_%28teaser%29.jpg'),
(3,'Steins;Gate Vol 1','Manga Japones','Yomi Sarachi','Ciencia Ficcion','Kamite','20151110',5,7200.00,'https://m.media-amazon.com/images/I/71zuetOTtxL.jpg');
